...
export default class Data {
  ...
  constructor() {
    ...
    //   this.selectedRange = figma.currentPage.selectedTextRange.node.characters.slice(figma.currentPage.selectedTextRange.start, figma.currentPage.selectedTextRange.end)
    // }
  }
  /**
   * changeTab
   ...
   */
  public getData() {
    const { selection, selectedTextNodes, selectedTextsForBatchEdit, pageChildrenCount, pluginData } = this;
    return { selection, selectedTextNodes, selectedTextsForBatchEdit, pageChildrenCount, ...pluginData };
  }
}