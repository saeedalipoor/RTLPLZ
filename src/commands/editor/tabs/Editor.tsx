...
function Editor(): JSX.Element {
  const { selectedTextNodes, selectedTextRange, settings } = useDataState();
  ...
  useLayoutEffect(() => {
    ...
    } else if (settings?.autoFocusOnSelectionChange && selectedTextRange && inputRef.current && !document.hasFocus()) {
      inputRef.current?.focus();
    }
  }, [selectedTextNodes, selectedTextRange]);
    ...
    <div class={classes.root}>
      <div class={classes.editor}>
        <Textfield
          ...
          bottomActions={[
            {
              label: <div class={classes.reverseButton}><IconReverse16 width="24" height="24" /><small class="hidden-xs">Reverse text</small></div>,
